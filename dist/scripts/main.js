...
/* harmony import */ var _Achievements_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _Assignments_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var _Jobs_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _Options_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3);
...
$(function() {
    var app = new Vue({
        ...
        methods: {
            ...
            buy: function() {
                ...
                if (this.money >= item.price) {
                    ...
                    $("#storeMsg").html(_Messages_js__WEBPACK_IMPORTED_MODULE_1__["Messages"].NotEnoughMoney)
                }
            },
            getJob: function() {
                var elementId = event.toElement.id;
            ...
            interview: function() {
                ...
                if (career.RequiredDays > this.stats.careerDays) {
                    this.log(_Messages_js__WEBPACK_IMPORTED_MODULE_1__["Messages"].YouAreNotHired_Days)
                    $("#careerMsg").html(_Messages_js__WEBPACK_IMPORTED_MODULE_1__["Messages"].YouAreNotHired_Days)
                    return;
                }
        ...
        computed: {
            ...
            currency: function() {
                return _Options_js__WEBPACK_IMPORTED_MODULE_5__["Options"].Currency;
            }
        }
    });
});
...
/* harmony import */ var _doruk_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _Options_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
...
const Messages_EN = {
    ...
    completed_job: `completed a freelance project and got paid {0} ${_Options_js__WEBPACK_IMPORTED_MODULE_1__["Options"].Currency}`,
    ...
    YouAreHired: `you're hired! everyday, you'll be assigned with tasks. complete them before they're due. Your salary per month is {0} ${_Options_js__WEBPACK_IMPORTED_MODULE_1__["Options"].Currency}`,
    ...
    SubscribeToBoard: `Subscribe for [0] ${_Options_js__WEBPACK_IMPORTED_MODULE_1__["Options"].Currency} to Jobs board`,
    ...
    PartialSalaryWired: `{0} ${_Options_js__WEBPACK_IMPORTED_MODULE_1__["Options"].Currency} for {1} days you worked was wired to your account.`,
...
const Messages_TR = {
    ...
    completed_job: `freelance bir projeyi tamamladın ve {0} ${_Options_js__WEBPACK_IMPORTED_MODULE_1__["Options"].Currency} kazandın`,
    ...
    YouAreHired: `işe alındın! her gün sana bazı görevler gelecek. bu görevleri süreleri dolmadan önce tamamlamalısın. Aylık maaşın {0} ${_Options_js__WEBPACK_IMPORTED_MODULE_1__["Options"].Currency}`,
    ...
    SubscribeToBoard: `Freelance mesaj panosuna üye ol([0] ${_Options_js__WEBPACK_IMPORTED_MODULE_1__["Options"].Currency})`,
    Description: "Tanım",
    LoC: "Satır Kod",
    ...
    MidLevelDeveloper: "Mid Level Developer",
    PartialSalaryWired: `{0} ${_Options_js__WEBPACK_IMPORTED_MODULE_1__["Options"].Currency} (çalıştığın {1} günün karşılığı) hesabına yatırıldı.`,
...
/* harmony import */ var _Items_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _Messages_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _Careers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
var Achievements = {
    ...
    at_1500: {
        ...
        Do: function(game) {
            ...
            game.availableCareers.push(_Careers_js__WEBPACK_IMPORTED_MODULE_2__["Careers"].sr_dev);
            game.availableCareers.push(_Careers_js__WEBPACK_IMPORTED_MODULE_2__["Careers"].team_leader);
        }
    },
    at_5000: {
...
var Careers = {
    ...
    sr_dev: {
        id: 3,
        title: _Messages_js__WEBPACK_IMPORTED_MODULE_0__["Messages"].SeniorDeveloper,
        LoC: 5000,
        RequiredDays: 90,
        annualSalary: 50000,
        failedAssignmentCount: 0,
    ...
    team_leader: {
        id: 4,
        title: _Messages_js__WEBPACK_IMPORTED_MODULE_0__["Messages"].TeamLeader,
        LoC: 10000,
        RequiredDays: 150,
        annualSalary: 75000,
        failedAssignmentCount: 0,
...
var Assignments = {
    ...
    FixProblemInPaymentIntegration: {
        title: _Messages_js__WEBPACK_IMPORTED_MODULE_1__["Messages"].FixProblemInPaymentIntegration,
        LoC: 25,
        deadline: 24,
        id: _doruk_js__WEBPACK_IMPORTED_MODULE_0__["Guid"].NewGuidWithoutDash(),
        chances: {
