...
const Messages_TR = {
    GameName: `Code Clicker V ${Version}`,
    welcome: "_Bilgisayar mühendisliği diplomanı aldın. İş ararken biraz kod yazsan iyi olur.",
    ...
    get_books: "Daha ciddi işlere girişmeden önce bazı kitaplar okusan iyi olur. İnternet mağazasına bak.",
    ...
    BrowseOnlineStore: "Mağaza",
    BluetoothHeadphones: "Bluetooth Kulaklık",
    LoCWritten: "Yazılan Kod Satırı Sayısı",
    Time: "Süre",
    Money: "Kazanç",
    BrowseCareers: "İş İlanları",
    Kindle: "E-Kitap",
    ToggleFreelance: "Freelance işler",
    WriteCodeButtonLabel: `1 tık[0] satır`,
